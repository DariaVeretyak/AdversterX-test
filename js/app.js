(() => {
    ...
    class FullPage {
        ...
        setEvents() {
            document.querySelectorAll(".hero__next").forEach((btn => {
                btn.addEventListener("click", (ev => {
                    if (this.activeSectionId < this.sections.length) this.switchingSection(this.activeSectionId + 1);
                }));
            }));
        }
        removeEvents() {
    ...
    const audioBtn = document.querySelector(".hero__music-btn");
    function playAudio() {
        audio.play();
    }
    function pauseAudio() {
    ...
    if (audio) audioBtn.addEventListener("click", (ev => {
        if (!audioBtn.classList.contains("stop")) pauseAudio(); else playAudio();
        audioBtn.classList.toggle("stop");
    }));
    playAudio();
